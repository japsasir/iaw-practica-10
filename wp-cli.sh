...
# IP pública.
IP_PUBLICA=54.221.76.41         #<<<<<<<Cambiar con cada uso !!!
...
wp core install --url=$IP_PUBLICA --title="Ciberseguridad blog Padilla" --admin_user=admin --admin_password=admin_password --admin_email=jose@gmail.com --allow-root
